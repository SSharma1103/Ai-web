  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="w-40 h-40 rounded-2xl flex flex-col items-center justify-center text-white cursor-grab
      ...
      >
        ...
        {/* Main AI+ text */}
        <motion.span 
          className="text-5xl font-bold drop-shadow-md text-white/90"
        ...
        {/* Subtitle text */}
        <motion.span 
          className="text-xs font-medium mt-2 text-center text-white/70 tracking-wider uppercase"
